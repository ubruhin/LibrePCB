...
class DomElement final
{
    ...
    private:
         ...
         */
        template <typename T>
        static T stringToObject(const QString& str, bool throwIfEmpty, const T& defaultValue = T()) noexcept;
...
template <>
inline QString DomElement::stringToObject(const QString& str, bool throwIfEmpty, const QString& defaultValue) noexcept {
...
template <>
inline bool DomElement::stringToObject(const QString& str, bool throwIfEmpty, const bool& defaultValue) noexcept {
...
template <>
inline int DomElement::stringToObject(const QString& str, bool throwIfEmpty, const int& defaultValue) noexcept {
    QString s = stringToObject<QString>(str, throwIfEmpty);
    bool ok = false;
...
template <>
inline uint DomElement::stringToObject(const QString& str, bool throwIfEmpty, const uint& defaultValue) noexcept {
    QString s = stringToObject<QString>(str, throwIfEmpty);
    bool ok = false;
...
template <>
inline QDateTime DomElement::stringToObject(const QString& str, bool throwIfEmpty, const QDateTime& defaultValue) noexcept {
    QString s = stringToObject<QString>(str, throwIfEmpty);
...
template <>
inline QColor DomElement::stringToObject(const QString& str, bool throwIfEmpty, const QColor& defaultValue) noexcept {
    QString s = stringToObject<QString>(str, throwIfEmpty);
    QColor obj(s);
    if (obj.isValid())      { return obj;           }
    else if (s.isEmpty())   { return defaultValue;  }
...
template <>
inline QUrl DomElement::stringToObject(const QString& str, bool throwIfEmpty, const QUrl& defaultValue) noexcept {
    QString s = stringToObject<QString>(str, throwIfEmpty);
...
template <typename T>
inline T DomElement::stringToObject(const QString& str, bool throwIfEmpty, const T& defaultValue) noexcept {
    QString s = stringToObject<QString>(str, throwIfEmpty);
    try {
